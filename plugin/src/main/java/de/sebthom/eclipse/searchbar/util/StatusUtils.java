 ...
 */
package de.sebthom.eclipse.searchbar.util;
...
public final class StatusUtils {
   ...
   public static IStatus createStatus(final int severity, final String msg, final Object... msgArgs) {
      if (msgArgs == null || msgArgs.length == 0)
         return new Status(severity, SearchBarPlugin.PLUGIN_ID, msg);
      return new Status(severity, SearchBarPlugin.PLUGIN_ID, NLS.bind(msg, msgArgs));
   }
   ...
   public static IStatus createStatus(final int severity, final Throwable ex, final String msg, final Object... msgArgs) {
      ...
      return new Status(severity, SearchBarPlugin.PLUGIN_ID, severity, statusMsg, ex);
   }
